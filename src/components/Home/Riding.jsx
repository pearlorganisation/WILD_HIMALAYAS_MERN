      ...
      <div className="pb-10 mb-5 md:mb-12">
          ...
          <div className="mx-auto container p-10">
            ...
            <div>
              <p className="text text-center text-lg py-5">
                ...
                explore diverse landscapes and cultures on two wheels. From
                scenic mountain routes to winding coastal roads, these tours
                provide an exhilarating way to experience the freedom of the
                open road. With guided or self-guided options available,
                motorbike tours cater to riders of all skill levels, offering
                unforgettable journeys and camaraderie along the way. Experience
                the thrill of exploration and the joy of discovery on a
                motorbike tour tailored to your adventurous spirit.
              </p>
            </div>
            <Swiper
              navigation={true}
        ...
        <div className="mx-auto container">
          <Link to="/ourcamp">
            ...
            <div>
              <p className="text text-center text-lg py-5">
                Camping offers a serene escape into nature, providing a chance
                to unwind and disconnect from the hustle and bustle of daily
                life. Whether pitching a tent under the stars or cozying up in a
                camper van, camping allows for immersion in the great outdoors.
                From cooking over an open fire to stargazing by the campfire,
                each moment is filled with simplicity and wonder. Embrace the
                beauty of nature and create lasting memories with loved ones on
                a camping adventure.
              </p>
              <Swiper
                slidesPerView={3}
