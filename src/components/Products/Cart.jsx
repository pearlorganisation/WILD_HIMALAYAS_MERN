            ...
            <div className="lg:w-1/3 xl:w-1/4">
              <div className="mt-6 space-y-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:mt-0 md:p-6">
                ...
                <div className="mt-4 text-center">
                  <a
                    href="#"
                    className="inline-block rounded-md bg-indigo-600 px-6 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Continue Shopping
                  </a>
                </div>
