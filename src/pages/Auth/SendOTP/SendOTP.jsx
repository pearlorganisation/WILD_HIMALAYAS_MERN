...
const SendOTP = () => {
    ...
    const onSubmit = (data) => {
        if (Object.keys(errors).length === 0) {
            ...
            navigate("/OtpVarfication"); // Navigate to the next page
        } else {
        ...
        <div className="max-w-lg mx-auto my-20 bg-white p-8 rounded-xl shadow shadow-slate-300 py-10 ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="my-10">
                <div className="flex flex-col space-y-5">
                    ...
                    <button
                        className="w-full py-3 font-medium rounded-lg text-white bg-black hover:shadow inline-flex space-x-2 items-center justify-center"
                        type="submit"
                    >
                        <svg
