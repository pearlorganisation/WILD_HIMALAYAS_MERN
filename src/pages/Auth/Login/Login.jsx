        ...
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-5">
                ...
                >
                    ...
                    {
                        isLoading ? <button
                            className="w-full px-4 py-1.5 text-white font-medium grid place-items-center  rounded-lg duration-150"
                        >
                            <div aria-label="Loading..." role="status" class="flex items-center space-x-2">
                                <svg class="h-8 w-h-8 animate-spin stroke-white" viewBox="0 0 256 256">
                            ...
                            className="w-full px-4 py-2 text-white bg-black font-medium  rounded-lg duration-150"
                        >
                            Sign in
                        </button>
                    }
                ...
                <p className="text-center">Don't have an account? <a href="javascript:void(0)" className="font-medium ">Sign up</a></p>
            </div>
        </main>
    );
}
